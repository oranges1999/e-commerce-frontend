  ...
  <main>
      ...
      <div class="flex justify-between w-full mb-[120px]">
        <div class="pt-[40px]">
          <div class="flex flex-col">
            <RouterLink v-for="link in category" class="w-[300px] flex justify-between items-center">
    ...
    <div class="border-b-2 border-[#d3d3d3] mb-[60px]">
        ...
        <div class="relative overflow-hidden">
          ...
          >
            <div 
              ...
              class="px-2"
            >
              <RouterLink class="group relative bg-white p-4 rounded-lg shadow relative">
      ...
      <div class="flex justify-center items-center py-[60px]">
        <button>
          <div class="w-[234px] h-[56px] flex justify-center items-center bg-[#DB4444] rounded-[4px]"> 
    ...
    <div class="border-b-2 border-[#d3d3d3] mb-[60px]">
      ...
      <div class="">
        ...
        <div class="flex justify-between my-[60px]">
          <RouterLink v-for="link in category" class="group w-[170px] h-[145px] rounded-[4px] flex justify-center items-center border-2 border-[#d3d3d3] hover:border-0 hover:bg-[#DB4444]">
